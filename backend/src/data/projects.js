...
const projects = [
  ...
  },
  {
    ...
    client: 'AbraStandard',
    duration: '3 meses',
    testimonial: 'A EvolveTech superou nossas expectativas. O site ficou moderno, rápido e nossos clientes adoraram a nova experiência.',
    results: {
  ...
  },
  {
    ...
    client: 'AbraEnergia',
    duration: '4 meses',
    testimonial: 'A plataforma revolucionou nossa forma de educar e converter clientes. O simulador de economia se tornou nossa principal ferramenta de vendas.',
    results: {
  ...
  },
  {
    ...
    description: 'Portal dedicado à sustentabilidade e meio ambiente, focado em educação ambiental, projetos de reflorestamento e iniciativas de redução de CO2. Uma plataforma que conecta pessoas e empresas com práticas sustentáveis.',
    ...
    technologies: ['React', 'Next.js', 'Strapi', 'PostgreSQL', 'Mapbox', 'D3.js', 'Vercel'],
    features: [
    ...
    duration: '3 meses',
    testimonial: 'A plataforma nos ajudou a amplificar nosso impacto ambiental. Conseguimos conectar mais pessoas com a causa da sustentabilidade.',
    results: {
  ...
  },
  {
    ...
    duration: '2 meses',
    testimonial: 'A plataforma transformou nossa capacidade de educar sobre sustentabilidade. Nosso alcance aumentou exponencialmente.',
    results: {
  ...
  },
  {
    ...
    description: 'Plataforma completa para empresa de energia solar fotovoltaica, com simulador de economia, sistema de orçamentos e marketplace de equipamentos. Solução digital que facilita a transição para energia limpa no Brasil.',
    ...
    technologies: ['React', 'TypeScript', 'Node.js', 'PostgreSQL', 'Stripe', 'Google Maps API'],
    features: [
    ...
    client: 'Start Solar',
    duration: '5 meses',
    testimonial: 'A plataforma revolucionou nosso negócio. O simulador automatizou 80% do nosso processo de vendas e aumentou drasticamente nossa conversão.',
    results: {
  ...
  },
  {
    ...
    description: 'Portal de inovação e empreendedorismo para a cidade de Londrina, conectando startups, investidores e talentos. Plataforma que fomenta o ecossistema de inovação local através de eventos, networking e oportunidades.',
    ...
    technologies: ['Vue.js', 'Nuxt.js', 'Firebase', 'Algolia', 'Stripe', 'Socket.io'],
    features: [
    ...
    duration: '4 meses',
    testimonial: 'A plataforma fortaleceu significativamente o ecossistema de inovação de Londrina. Conseguimos conectar muito mais empreendedores e investidores.',
    results: {
  ...
  },
  {
    ...
    duration: '3 meses',
    testimonial: 'A loja virtual superou todas as expectativas. O try-on virtual e a integração com redes sociais revolucionaram nossa conversão.',
    results: {
  ...
  },
  {
    ...
    description: 'Plataforma de e-commerce inovadora com sistema de gamificação e recompensas. Uma solução única que combina vendas online com elementos de jogos, criando uma experiência envolvente para compradores e vendedores.',
    ...
    technologies: ['React', 'Node.js', 'MongoDB', 'Stripe', 'Redis', 'Socket.io', 'AWS'],
    features: [
    ...
    client: 'Vem Ganhar',
    duration: '4 meses',
    testimonial: 'O sistema de gamificação revolucionou nossa plataforma. As vendas aumentaram drasticamente e os usuários estão muito mais engajados.',
    results: {
  ...
  // Projetos antigos mantidos para demonstração (podem ser removidos se necessário)
  {
    ...
    description: 'Aplicativo mobile completo para gestão financeira pessoal com IA integrada para análise de gastos e investimentos. Oferece uma experiência bancária moderna e segura.',
    ...
    technologies: ['React Native', 'TypeScript', 'Node.js', 'PostgreSQL', 'TensorFlow', 'Biometrics'],
    features: [
    ...
    client: 'FinanceNext',
    duration: '6 meses',
    testimonial: 'A EvolveTech criou um app que compete com os maiores bancos digitais. A segurança e usabilidade são excepcionais.',
    results: {
      users: '50k+ usuários',
