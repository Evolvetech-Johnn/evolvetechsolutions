...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, ...props }, ref) => {
    const variants = {
      ...
      secondary: 'bg-secondary text-white hover:bg-secondary-hover shadow-lg shadow-secondary/30 border border-transparent',
      ...
      danger: 'bg-error text-white hover:bg-red-600 shadow-lg shadow-error/30 border border-transparent',
    };
