  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden flex flex-col md:flex-row">
      <div className="bg-slate-50 p-6 md:w-1/3 border-b md:border-b-0 md:border-r border-slate-200 flex flex-col justify-center">
        ...
        <p className="text-sm text-slate-500 flex items-center gap-1 mt-auto pt-4">
      ...
      <div className="p-6 md:w-2/3 flex flex-col gap-4">
        <div>
          <p className="text-sm font-semibold text-slate-800 uppercase tracking-wide mb-1 flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-red-500"></span> O Problema
          </p>
          <p className="text-slate-600 text-sm">{recommendation.problema}</p>
        </div>
        
        <div>
          <p className="text-sm font-semibold text-slate-800 uppercase tracking-wide mb-1 flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> O Benefício Esperado
          </p>
          <p className="text-slate-600 text-sm">{recommendation.beneficioEsperado}</p>
        </div>
